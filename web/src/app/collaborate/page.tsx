...
export default function CollaboratePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0b0c0e] text-white transition-colors duration-300 relative font-sans selection:bg-dutchOrange selection:text-white">
      ...
      {/* Collaboration Pathways Grid (Charcoal Band #121417) */}
      <section className="bg-[#121417] py-20 border-b border-zinc-900/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              whileHover={{ y: -4 }}
              className="p-8 rounded-2xl bg-[#131519] border border-[#22252c] shadow-xl space-y-6 flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-sans text-lg font-semibold text-white">Pro-Bono SCADA Audit</h3>
                </div>
                ...
                <ul className="space-y-2 text-xs text-zinc-400 font-sans border-t border-zinc-900 pt-3">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-sans text-lg font-semibold text-white">Academic Fellowship</h3>
                </div>
                <p className="text-xs text-zinc-300 font-sans leading-relaxed font-light">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-sans text-lg font-semibold text-white">Actuarial Validation</h3>
                </div>
                <p className="text-xs text-zinc-300 font-sans leading-relaxed font-light">
      ...
      {/* Application Form Section (Elevated Slate Band #16181d) */}
      <section className="bg-[#16181d] py-20 border-b border-zinc-900/60">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="p-8 sm:p-12 rounded-2xl bg-[#131519] border border-[#22252c] shadow-2xl space-y-8">
            ...
            {submitted ? (
              <div className="p-8 rounded-2xl bg-[#0b0c0e] border border-zinc-800 text-center space-y-5 font-mono">
                ...
                <p className="text-xs text-zinc-300 font-sans max-w-md mx-auto leading-relaxed">
                  Thank you for reaching out to Eigenia Labs. Your proposal details have been captured and queued for <strong className="text-white">jim@eigenia.nl</strong>.
                </p>
                <div className="pt-2">
                  <a
              ...
              <form onSubmit={handleSubmit} className="space-y-6 font-mono text-xs">
                ...
                <div className="space-y-2">
                  <label className="text-zinc-400 uppercase text-[11px] block">Selected Engagement Pathway</label>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl transition-colors text-left ${
                          selectedType === type.id
                            ...
                            : "bg-[#0b0c0e] border border-zinc-800 text-zinc-300 hover:text-white"
                        }`}
                      >
                        {type.label}
                      </button>
                ...
                <div className="space-y-2">
                  <label className="text-zinc-400 uppercase text-[11px] block">Target Research Track</label>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {[
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-zinc-400 uppercase text-[10px] block">Full Name / Lead Researcher</label>
                    <input
                      type="text"
                      required
                      value={name}
                      ...
                      className="w-full p-3 rounded-xl bg-[#0b0c0e] border border-zinc-800 text-white focus:outline-none focus:border-dutchOrange font-sans text-xs"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="text-zinc-400 uppercase text-[10px] block">Institutional / Corporate Email</label>
                    <input
                      type="email"
                      required
                      value={email}
                ...
                <div className="space-y-1">
                  <label className="text-zinc-400 uppercase text-[10px] block">Organization / Utility Entity Name</label>
                  <input
                    type="text"
                    required
                    value={company}
                ...
                <div className="space-y-1">
                  <label className="text-zinc-400 uppercase text-[10px] block">Proposal Overview & Technical Objectives</label>
                  <textarea
                    rows={4}
                    required
                    value={message}
