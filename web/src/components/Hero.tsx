...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative pt-28 pb-16 bg-canvas text-primary transition-colors duration-300 selection:bg-dutchOrange selection:text-white border-b border-hairline"
    >
