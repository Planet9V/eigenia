...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative pt-28 pb-16 bg-[#0b0c0e] text-white transition-colors duration-300 selection:bg-dutchOrange selection:text-white border-b border-zinc-900/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl space-y-6">
          ...
          <h1 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-normal text-white tracking-tight leading-[1.15]">
          ...
          <p className="font-sans text-base sm:text-lg text-zinc-300 font-light leading-relaxed max-w-3xl">
