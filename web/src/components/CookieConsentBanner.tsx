    ...
    <>
      ...
      {!showPreferences && (
        <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:max-w-md z-50 animate-fade-in font-mono">
          <div className="bg-surface p-6 rounded-2xl shadow-2xl space-y-4 text-primary border border-hairline transition-colors duration-300">
      ...
      {showPreferences && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in font-mono">
          <div className="relative w-full max-w-lg bg-surface rounded-2xl p-6 sm:p-8 shadow-2xl text-primary space-y-6 border border-hairline transition-colors duration-300">
            <div className="flex items-center justify-between border-b border-hairline pb-4">
              <div className="flex items-center gap-2">
                <Cookie className="w-5 h-5 text-dutchOrange" />
                <h3 className="text-sm font-bold text-primary uppercase">Cookie Privacy Preferences</h3>
              </div>
              <button
                onClick={() => {
                  setShowPreferences(false);
                ...
                className="p-1 rounded bg-subtle text-muted hover:text-primary"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-4 text-xs font-sans">
              <div className="flex items-center justify-between p-3 rounded-xl bg-subtle border border-hairline">
                <div>
                  <span className="font-bold text-primary block">Strictly Necessary Cookies</span>
                  <span className="text-secondary text-[11px]">Required for website operation and security authentication.</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-subtle border border-hairline">
                <div>
                  <span className="font-bold text-primary block">Performance & Analytics</span>
                  <span className="text-secondary text-[11px]">Privacy-friendly telemetry to optimize load speeds and SCADA digital twin responsiveness.</span>
                </div>
                <input
                  type="checkbox"
                  checked={analytics}
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-subtle border border-hairline">
                <div>
                  <span className="font-bold text-primary block">Marketing & Targeting</span>
                  <span className="text-secondary text-[11px]">Eigenia B.V. does not deploy cross-site tracking or third-party ad retargeting.</span>
                </div>
                <input
                  type="checkbox"
                  checked={marketing}
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-hairline font-mono text-xs">
              <button
                onClick={handleSavePreferences}
                className="py-2.5 px-5 rounded-xl bg-dutchOrange text-white font-bold hover:bg-dutchOrange/90 transition-colors shadow-md"
              >
                Save Preferences
              </button>
            </div>
