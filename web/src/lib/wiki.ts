...
export const WORKING_GROUPS: WorkingGroupCategory[] = [
  ...
  },
  {
    ...
    number: "WG-05",
    badge: "CAD STANDARDS 01–06",
    badgeNl: "CAD STANDAARDEN 01–06",
    ...
    documents: [
      ...
      },
      {
        ...
        subtitle: "Why DEXPI 2.0 (ISO 15926) is the open foundation for industrial cyber-physical twins",
        subtitleNl: "Waarom DEXPI 2.0 (ISO 15926) de open basis is voor industriële cyber-fysieke tweelingen",
        workingGroupId: "WG-05-CAD",
        workingGroupName: "DEXPI 2.0 & CAD Interoperability",
        workingGroupNameNl: "DEXPI 2.0 & CAD Interoperabiliteit",
