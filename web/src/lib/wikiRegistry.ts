...
export const WORKING_GROUPS: WorkingGroupCategory[] = [
  ...
  },
  {
    ...
    number: "WG-05",
    badge: "CAD STANDARDS 01–16",
    badgeNl: "CAD STANDAARDEN 01–16",
    ...
    documents: [
      {
        ...
        subtitle: "Integrating physical plant topology (ISO 15926 series) with software bill of materials (SBOM)",
        subtitleNl: "Integratie van fysieke fabriekstopologie (ISO 15926-serie) met software-stuklijst (SBOM)",
      ...
      },
      {
        ...
        subtitle: "Bridging physical plant hydronics (ISO 15926 series) and multi-tier cybersecurity architecture (ECMA-424)",
        subtitleNl: "Overbrugging van fysieke fabriekshydronica (ISO 15926-serie) en meerlaagse cyberbeveiligingsarchitectuur (ECMA-424)",
        workingGroupId: "WG-05-CAD",
        workingGroupName: "DEXPI 2.0 & CAD Interoperability",
        workingGroupNameNl: "DEXPI 2.0 & CAD Interoperabiliteit",
      ...
      },
      {
        ...
        slug: "multigraph-engine",
        title: "The G_CPDT Multigraph Engine: Dual-Representation Storage and Cypher Query Algebra",
        subtitle: "A labelled property graph core with an RDF/OWL export facade, traversing the five normative G_CPDT relations",
        workingGroupId: "WG-05-CAD",
        workingGroupName: "DEXPI 2.0 & CAD Interoperability",
        workingGroupNameNl: "DEXPI 2.0 & CAD Interoperabiliteit",
      ...
      },
      {
        ...
        subtitle: "Why CVSS fails in cyber-physical systems, and consequence as a non-linear function of a crossed threshold",
        workingGroupId: "WG-05-CAD",
        workingGroupName: "DEXPI 2.0 & CAD Interoperability",
        workingGroupNameNl: "DEXPI 2.0 & CAD Interoperabiliteit",
        ...
        author: "J. McKenney",
        publicationDate: "September 11, 2026",
        badge: "KINETIC CONSEQUENCE",
        badgeNl: "KINETISCH GEVOLG",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    number: "WG-10",
    badge: "ASSURANCE NETWORK 01",
    badgeNl: "ASSURANCENETWERK 01",
    description: "The Product Assurance Network Working Group treats statutory conformance as an engineering problem rather than a documentation exercise. Its subject is the machinery that turns a regulation into a checkable artifact: product classification and conformity routes under the EU Cyber Resilience Act, the Article 14 reporting clocks, and the automated falsification of vulnerability exploitability against a cyber-physical asset graph. The aim is that a manufacturer can demonstrate conformance from evidence a machine produced and an auditor can re-derive, rather than from prose assembled by hand.",
    descriptionNl: "De Werkgroep Netwerk voor Productassurance behandelt wettelijke conformiteit als een technisch vraagstuk en niet als een documentatieoefening. Het onderwerp is de machinerie die een verordening omzet in een controleerbaar artefact: productclassificatie en conformiteitsroutes onder de EU Cyber Resilience Act, de meldingstermijnen van Artikel 14, en het geautomatiseerd falsifiëren van exploiteerbaarheid tegen een cyber-fysieke activagraaf. Het doel is dat een fabrikant conformiteit kan aantonen met bewijs dat een machine heeft voortgebracht en een auditor opnieuw kan afleiden.",
    documents: [
      {
        id: "WG-10-AN-06-CRA-Product-Assurance",
        slug: "cra-product-assurance",
        title: "Statutory Product Assurance: EU Cyber Resilience Act (CRA) & Machine-Speed VEX Falsification",
        subtitle: "Article 14 reporting clocks, product classification, and topological falsification of vulnerability exploitability",
