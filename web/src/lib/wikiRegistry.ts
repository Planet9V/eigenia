...
export const WORKING_GROUPS: WorkingGroupCategory[] = [
  {
    ...
    documents: [
      ...
      },
      {
        ...
        workingGroupId: "WG-01-UI",
        workingGroupName: "Cyber Underwriting & Insurance",
        workingGroupNameNl: "Cyber-Acceptatie & Verzekering",
  ...
  },
  {
    ...
    number: "WG-02",
    badge: "DIGITAL TWIN 01–21",
    badgeNl: "DIGITALE TWEELING 01–21",
    ...
    documents: [
      ...
      },
      {
        ...
        workingGroupId: "WG-02-DT",
        workingGroupName: "Digital Twin & Taleb Series",
        workingGroupNameNl: "Digital Twin & Taleb-reeks",
  ...
  },
  {
    ...
    number: "WG-03",
    badge: "PSYCHOMETRICS 01–11",
    badgeNl: "PSYCHOMETRIE 01–11",
  ...
  },
  {
    ...
    number: "WG-04",
    badge: "CASCADING FAILURES 01–13",
    badgeNl: "CASCADERENDE STORINGEN 01–13",
  ...
  },
  {
    ...
    number: "WG-05",
    badge: "CAD STANDARDS 01–23",
    badgeNl: "CAD STANDAARDEN 01–23",
  ...
  {
    id: "WG-06-SC",
    title: "Statutory Supply Chain & Product Conformance",
    titleNl: "Wettelijke Toeleveringsketen & Productconformiteit",
    number: "WG-06",
    badge: "STATUTORY CONFORMANCE 01–05",
    badgeNl: "WETTELIJKE CONFORMITEIT 01–05",
    description: "The Statutory Supply Chain & Product Conformance Working Group codifies regulatory mandates as machine-executable engineering models. Focusing on the EU Cyber Resilience Act (Regulation (EU) 2024/2847), the group operationalizes Article 14 mandatory reporting clocks, automated vulnerability triage via CycloneDX 1.6+ VEX falsification, and verifiable Technical Documentation Dossiers for European Notified Bodies under Module B and Module H conformity pathways.",
    descriptionNl: "De Werkgroep Wettelijke Toeleveringsketen & Productconformiteit codificeert wettelijke mandaten als machine-uitvoerbare technische modellen. Met de focus op de EU Cyber Resilience Act (Verordening (EU) 2024/2847) operationaliseert de werkgroep Artikel 14 rapportagetermijnen, geautomatiseerde kwetsbaarheidstriage via CycloneDX 1.6+ VEX-falsificatie en verifieerbare Technische Documentatiedossiers voor Europese Aangemelde Instanties onder Module B en Module H conformiteitstrajecten.",
    documents: [
      {
        ...
        workingGroupName: "Statutory Supply Chain & Product Conformance",
        workingGroupNameNl: "Wettelijke Toeleveringsketen & Productconformiteit",
  ...
  },
  {
    ...
    number: "WG-07",
    badge: "THREAT MODELING 01–11",
    badgeNl: "DREIGINGSMODELLERING 01–11",
  ...
  },
  {
    ...
    badgeNl: "ASSURANCENETWERK 01–09",
    description: "The Product Assurance Network Working Group establishes a decentralized, two-sided verification marketplace and clearinghouse for industrial cyber-physical equipment. By unifying CAD-DEXPI 2.0 physical topology, CycloneDX 1.6+ multi-BOMs, and IEC 61970 CIM electrical models into the Schema G_CPDT contract, PAN eliminates bilateral procurement spreadsheets, automates statutory gap analysis across 249 global jurisdictions, and powers high-throughput programmatic procurement APIs.",
    descriptionNl: "De Werkgroep Netwerk voor Productassurance vestigt een gedecentraliseerde, tweezijdige verificatiemarktplaats en clearinghouse voor industriële cyber-fysieke apparatuur. Door de fysieke topologie van CAD-DEXPI 2.0, multi-BOM's van CycloneDX 1.6+ en elektrische CIM-modellen van IEC 61970 te verenigen in het Schema G_CPDT-contract, elimineert PAN bilaterale inkoopspreadsheets, automatiseert het wettelijke gap-analyses over 249 wereldwijde jurisdicties en stuurt het hoog-volume programmatische inkoop-API's aan.",
    documents: [
      {
