#!/usr/bin/env python3
"""
Compiler for Paper P-04: CyHAZOP: Cyber-Physical Hazard Analysis for Hyperscale Infrastructure
Enhanced with complete multi-BOM linkage, DEXPI 2.0 node mapping,
