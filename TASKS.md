<!-- verified: 2026-09-13 837833c -->
# Tasks

_Last brought current: 2026-09-13 verified against main at `837833c`. The HTML comment on line 1 is machine-read by `web/scripts/audit-tasks-stamp.mjs` and `scripts/hooks/`; update it every time this file is brought current._
