<!-- verified: 2026-09-14 ac5f276 -->
# Tasks

_Last brought current: 2026-09-14 verified against main at `ac5f276`. The HTML comment on line 1 is machine-read by `web/scripts/audit-tasks-stamp.mjs` and `scripts/hooks/`; update it every time this file is brought current._
