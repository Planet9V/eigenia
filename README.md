...
├── /tracks                         [Standalone Route: 10 Research Tracks — renders the working groups]
...
├── /wiki                           [Standalone Route: Sovereign Research Wiki — 66 Treatises, 10 Working Groups]
│
...
│   └── ... (10 working groups, 66 treatises total)
│
