...
The key words MUST, MUST NOT, SHOULD, SHOULD NOT and MAY in this document are to be interpreted as described in RFC 2119 [3]. Requirements defined herein are numbered S-1 through S-5. This document is licensed under the Creative Commons Attribution 4.0 International licence (CC BY 4.0) [4] for submission to the European Commission, ENISA, European Notified Bodies, CISA, and IEC TC 65.
...
```json
{
  ...
  "vulnerabilities": [
    {
      "bom-ref": "cve-2024-55321",
      "id": "CVE-2024-55321",
      "source": { "name": "NVD", "url": "https://nvd.nist.gov/vuln/detail/CVE-2024-55321" },
      "analysis": {
        "state": "not_affected",
...
For Important Class II and Critical products, manufacturers cannot self-certify under Module A; they must undergo EC-type examination (Module B) followed by conformity to type (Module C), or Full Quality Assurance (Module H) conducted by a designated European Notified Body under Article 32.
