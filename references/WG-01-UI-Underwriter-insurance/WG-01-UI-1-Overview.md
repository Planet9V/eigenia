...
## 2. The Lead Underwriters and Fronting Carriers Global carriers such as **Zurich Insurance Group, Allianz, AXA, and Chubb** take on the actual risk by issuing policies.
...
## 3. Captive Insurers Large multinational corporations often create their own self-managed insurance companies, known as captives. For example, Heineken utilizes its own **Roeminck Insurance N.V.**.
...
## 4. Reinsurers Companies like **Munich Re and Swiss Re** act as the "insurers for the insurers".
...
## 5. Risk Analytics and Modeling Platforms Firms like **CyberCube, Moody's RMS, BitSight, SecurityScorecard, and DeNexus** provide the data infrastructure for the industry.

- **What they do:** They build software that runs catastrophe scenarios, continuous risk scoring, and portfolio aggregation.

## 6. **How They Underwrite Complex Risks (Techniques & Processes)**
