...
**P1 and P3 carry a citation defect this document corrects.** Both designate the 2021 CGMES editions as Technical Specifications [1], [2]. The IEC catalogue records IEC 61970-600-1:2021 and IEC 61970-600-2:2021 as first-edition International Standards, published 4 June 2021, cancelling and replacing the 2017 Technical Specifications [9], [10]. Section 3 states the correct designation. Both earlier papers should be amended, and the defect is recorded here rather than silently diverged from.
