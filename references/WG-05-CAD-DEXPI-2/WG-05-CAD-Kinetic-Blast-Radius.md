...
- **Kinetic Blast Radius**: Loss of 32 AI accelerators (1.28 million USD replacement) plus two weeks cluster downtime (4.2 million USD business interruption). Total $R_K = 5.48\text{ million USD}$.
...
- **Kinetic Blast Radius**: Transformer thermal damage and regional blackout impact spanning 180,000 residential and industrial meters. Total $R_K = 28.6\text{ million USD}$.
