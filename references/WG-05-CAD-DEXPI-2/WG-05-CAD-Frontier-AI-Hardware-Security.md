...
4. **Manufacturing Bill of Materials (MBOM)**: Carries the provenance of the physical materials the HBOM enumerates: copper cold plate metallurgy, ethylene-propylene-diene-monomer (EPDM) seal formulations, dielectric fluid chemical specifications, manifold weld procedure records, wafer lot numbers, and ODM chain-of-custody signatures. Equipment classes are stated against ISO 15926 equipment taxonomies, ensuring that counterfeit mechanical elements that degrade thermal safety are identified prior to operational energization.
