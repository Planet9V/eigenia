...
> The OXOT CDT uses **6 physics-inspired indicators** derived from the `seldon.psychohistory_state` PostgreSQL table. These values are read by the Seldon Score endpoint and the L6 globe layer to produce risk gauges on the CDT dashboard.
