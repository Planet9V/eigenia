...
One file per source: `<WG-code>_<topic-slug>_<YYYYMMDD>.md`, e.g.
`WG-07-TM_kramers-escape-rate_20260812.md`. The WG-code prefix ties the
source back to the working-group folder it supports.
