...
The most likely attack scenario is Retailer API compromise leading to 54 BESS oscillation. This produces a local cascade affecting 100,000-500,000 customers with an 8-24 hour outage and [investment required] million economic damage. The worst case scenario is system-wide collapse. This affects 1.2 million customers for 24-72 hours with [investment required] million-[investment required] billion damage and 5-25 fatalities.
